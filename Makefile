...
# Generated by qmake (2.01a) (Qt 4.8.7) on: mar. mars 21 15:07:06 2017
# Project:  main.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/tp071.0.0/ && $(COPY_FILE) --parents shader.h meshLoader.h trackball.h camera.h viewer.h .tmp/tp071.0.0/ && $(COPY_FILE) --parents shader.cpp meshLoader.cpp trackball.cpp camera.cpp main.cpp viewer.cpp .tmp/tp071.0.0/ && (cd `dirname .tmp/tp071.0.0` && $(TAR) tp071.0.0.tar tp071.0.0 && $(COMPRESS) tp071.0.0.tar) && $(MOVE) `dirname .tmp/tp071.0.0`/tp071.0.0.tar.gz . && $(DEL_FILE) -r .tmp/tp071.0.0
